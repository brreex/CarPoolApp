...
<script src="resource/js/askingg.js" type="text/javascript"></script>
...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		<div class="container">
			...
			<div id="navbar" class="navbar-collapse collapse">
				...
				<li class="active"><a href="asking.jsp"><i class="fa fa-car" aria-hidden="true"></i>
							Asking</a></li>
					
					<li><a href="mypost.jsp"><i class="fa fa-id-card-o" aria-hidden="true"></i> My
							Post</a></li>
					<li>
						<div id="not">
